...
const formatMovement = function (date, locale) {
  ...
  if(daysPassed1 === 0) {
    return 'Today';
  } else if(daysPassed1 === 1) {
    return 'Yesterday';
  } else if (daysPassed1 <= 7) {
    return `${daysPassed1} days ago`
  } else {
...
const day1 = daysPassed(new Date (2037, 3, 14), new Date (2037, 3, 4, 10, 8));
console.log(day1);*/

/*
const num = 438924723.23;
