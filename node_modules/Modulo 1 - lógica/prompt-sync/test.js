//basic:
console.log(require('Modulo 1 - lógica/prompt-sync')()('tell me something about yourself: '))

// ANSI escape codes colored text test
require('Modulo 1 - lógica/prompt-sync')()('\u001B[31mcolored text: \u001B[39m');

var prompt = require('Modulo 1 - lógica/prompt-sync')({
