...
Funções Sugeridas:
cadastrarProduto(estoque): Cadastra um novo produto no vetor estoque.
atualizarEstoque(estoque, codigo): Atualiza a quantidade de um produto específico.
consultarProdutos(estoque): Exibe a lista de todos os produtos cadastrados.
